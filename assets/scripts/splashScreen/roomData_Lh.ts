...
import { singelRoom_Lh } from './singelRoom_Lh';
...
export class roomData_Lh extends Component {
    roadmapItem:any  = []
    ...
    setData(data:any) {
        ...
        for (let data = 0; data < this.roadmapItem.length; data++) {
            ...
            const singleRoomComponent = item.getComponent('singelRoom_Lh') as singelRoom_Lh
